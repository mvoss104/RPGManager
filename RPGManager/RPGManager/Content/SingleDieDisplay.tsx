...
class SingleDieDisplay extends React.Component {
    ...
    render() {
        ...
        let gradient = null;
        if (this.props.primaryColor.length == 1) {
            fillString = this.props.primaryColor[0];
        }
        else {
            fillString = "url(#gradient)";
            let percent = 100 / (this.props.primaryColor.length - 1);
            let stops = [];
            for (let c = 0; c < this.props.primaryColor.length; c++) {
                stops.push(<stop key={c} style={{ stopColor: this.props.primaryColor[c] }} offset={(percent * c) + "%"} />);
            }
        ...
        switch (this.props.type)
        {
            case DiceType.d4:
                svgContents = <svg style={{
                    ...
                    <text x="190" y="400" style={{ fill: this.props.textColor, fontSize: "250px" }}>{this.props.value}</text>
                </svg>
                break;
            case DiceType.d6:
                svgContents = <svg style={{
                    ...
                    <text x="170" y="375" style={{ fill: this.props.textColor, fontSize: "350px" }}>{this.props.value}</text>
                </svg>
                break;
            case DiceType.d8:
                svgContents = <svg style={{
                    ...
                    {gradient}
                    <circle style={{ fill: "#FFFFFF" }} cx="250" cy="250" r="200"></circle>
                    ...
                    <text x="210" y="300" style={{ fill: this.props.textColor, fontSize: "150px" }}>{this.props.value}</text>
                </svg>
                break;
            case DiceType.d10:
                svgContents = <svg style={{
                    ...
                    <text x={this.props.value >= 10 ? "165" : "210"} y="240" style={{ fill: this.props.textColor, fontSize: "150px" }}>{this.props.value}</text>
                </svg>
                break;
            case DiceType.d12:
                svgContents = <svg style={{
                    ...
                    {gradient}
                    <circle style={{ fill: "#FFFFFF" }} cx="250" cy="250" r="250"></circle>
                    ...
                    <text x={this.props.value >= 10 ? "165" : "210"} y="300" style={{ fill: this.props.textColor, fontSize: "150px" }}>{this.props.value}</text>
                </svg>
                break;
            case DiceType.d20:
                svgContents = <svg style={{
                    ...
                    <g transform="translate(-246.69 -375.67)">
                        <circle style={{ fill: "#FFFFFF" }} cx="382.794" cy="537.251" r="145"></circle>
                    ...
                    <text x={this.props.value >= 10 ? "88" : "115"} y="180" style={{ fill: this.props.textColor, fontSize: "75px" }}>{this.props.value}</text>
                </svg>
                break;
        }
