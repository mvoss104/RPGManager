...
class PortraitLifebar extends React.Component {
    ...
    /**
     * Drag event
     * @param event the parent element
     */
    public drag(event: React.DragEvent<HTMLDivElement>) {
        event.dataTransfer.setData("text", this.props.characterId.toString());
    }
    ...
    render() {
        ...
        return (
            <div draggable={this.props.draggable} onDragStart={this.props.draggable ? this.drag : null}>
